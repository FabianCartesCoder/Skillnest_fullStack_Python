...
#
# Salida : 
# No imprime nada por que la función no existe.
...
# x --------| None
# Salida : 24
# x no imprime nada por que la función no tiene valor de retorno.
...
# a --------| 560000
# Salida : 56000, 46
# El tercer return no se alcanza a ejecutar, por que esta fuera de las condicionales.
...
# b -------| 4
# Salida : 7
# El segundo return no se alcanza a ejecutar por que el de arriba rompe la función.
